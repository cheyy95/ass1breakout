...
public class ObjectSprite {
    ...
    public ObjectSprite(Texture tex, World world, float x, float y, float scale, BodyDef bodyDef, FixtureDef fixtureDef, Object bodyUserData, Object fixtureUserData) {
        this.scale = scale;
    ...
    public ObjectSprite(Texture tex, World world, float x, float y, float scale, BodyDef bodyDef, FixtureDef fixtureDef) {
        this(tex, world, x, y, scale, bodyDef, fixtureDef, null, null);
    }

    public ObjectSprite(Defs defs, World world, Object bodyUserData, Object fixtureUserData) {
        this(defs.tex, world, defs.x, defs.y, defs.scale, defs.bodyDef, defs.fixtureDef, bodyUserData, fixtureUserData);
    }

    public ObjectSprite(Defs defs, World world) {
